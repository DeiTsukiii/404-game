...
function preload() {
    this.load.bitmapFont('pixelFont', 'assets/404/pixel-font.png', 'assets/404/pixel-font.xml');
    this.load.audio('platformSound', 'assets/404/platform.mp3');
}
...
function create() {
    ...
    scoreText = this.add.bitmapText(10, 10, 'pixelFont', '0', 30).setDepth(11).setScrollFactor(0);
    ...
    startGame = this.add.container(225, 350).setVisible(true).setDepth(100);
